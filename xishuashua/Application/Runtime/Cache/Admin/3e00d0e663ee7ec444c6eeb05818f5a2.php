...
<head>
    ...
    <link href="/h5_2014_xishuashua/xishuashua/Public/admin/css/center.css" rel="stylesheet">
...
<div class="container">
    ...
    <div class="row con1">
        ...
        <div class="col-md-4">
            <div class="head">
                <img src="/h5_2014_xishuashua/xishuashua/Public/admin/images/cp_head.jpg" alt="cp_head"/>
        ...
        <div class="col-md-12">
            <div class="add">
                ...
                <li class="wen">
                    ...
                    <li class="wen">
                        <img src="/h5_2014_xishuashua/xishuashua/Public/admin/images/roll01.jpg" alt="01" style="margin-right:10px;">
                        <img src="/h5_2014_xishuashua/xishuashua/Public/admin/images/roll02.jpg" alt="02" style="margin-right:10px;">
                        <img src="/h5_2014_xishuashua/xishuashua/Public/admin/images/roll03.jpg" alt="03" style="margin-right:10px;">
                    </li>
                <li>
                    <div class="row">
                        <div class="col-md-10">
            ...
            <div class="add">
                ...
                <li class="wen">
                    ...
                    <li class="wen">
                        <img src="/h5_2014_xishuashua/xishuashua/Public/admin/images/roll01.jpg" alt="01" style="margin-right:10px;margin-bottom:10px;">
                        <img src="/h5_2014_xishuashua/xishuashua/Public/admin/images/roll02.jpg" alt="02" style="margin-right:10px;margin-bottom:10px;">
                        <img src="/h5_2014_xishuashua/xishuashua/Public/admin/images/roll03.jpg" alt="03" style="margin-right:10px;margin-bottom:10px;">
                    </li>
                <li>
                    <div class="row">
                        <div class="col-md-10">
