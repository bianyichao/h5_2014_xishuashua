...
<div class="container-fluid">
    ...
    <!--content 1-->
    <div class="row con">
        <a href="regist.html">业主注册</a>
        <a href="" class="chosed">家装公司注册</a>
        <div class="col-md-12">
            <div class="col-md-4"></div>
            <div class="col-md-8">
                <form action="doregist_cp" method="post">
                <input type="hidden" name="b_tag" value="1">
                    <ul class="specialul">
                        <li>
                            <p>公司名称</p>
                            <input type="text" name="b_name" placeholder="请填写完整的公司名称"/>
                            <!--输入框内信息判断无误后，使用JS方法显示该图片-->
                            <img src="/h5_2014_xishuashua/xishuashua/Public/admin/images/ok.jpg" alt="ok"/>
                        </li>
                        <li>
                            <p>公司用户名</p>
                            <input type="text" name="b_ename" placeholder="建议使用公司名称的全拼或英文名"/>
                            <!--输入框内信息判断无误后，使用JS方法显示该图片-->
                            <img src="/h5_2014_xishuashua/xishuashua/Public/admin/images/ok.jpg" alt="ok"/>
                        </li>
                        <li>
                        ...
                        <li>
                            <p></p>
                            <input type="text" name="b_address" placeholder="请填写具体地址"/>
                            <!--输入框内信息判断无误后，使用JS方法显示该图片-->
                            <img src="/h5_2014_xishuashua/xishuashua/Public/admin/images/ok.jpg" alt="ok"/>
                        </li>
                        <li class="line"></li>
                        <li>
                            <p>密码</p>
                            <input type="password" name="b_pwd" placeholder="不少于六位(字母、数字、下划线)"/>
                            <!--输入框内信息判断无误后，使用JS方法显示该图片-->
                            <img src="/h5_2014_xishuashua/xishuashua/Public/admin/images/ok.jpg" alt="ok"/>
                        </li>
                        <li>
                        ...
                        <li>
                            <p>公司邮箱</p>
                            <input type="email" name="b_email" placeholder="请填写真实邮箱"/>
                            <!--输入框内信息判断无误后，使用JS方法显示该图片-->
                            <img src="/h5_2014_xishuashua/xishuashua/Public/admin/images/ok.jpg" alt="ok"/>
                        </li>
                        <li>
                            ...
                            <input class="phone" type="text" name="b_tel" placeholder=""/>
                            <!--输入框内信息判断无误后，使用JS方法显示该图片-->
                            <img src="/h5_2014_xishuashua/xishuashua/Public/admin/images/ok.jpg" alt="ok"/>
                        </li>
                        <li class="already">
                        ...
                        <li>
                            <input type="submit" tabindex="3" value="公司注册" class="btn btn-success"/>
                        </li>
                        <li class="goto">
                            <a href="dl_cp.html">已有账号，直接登录&gt;&gt;</a>
                        </li>
                    </ul>
                </form>
            </div>
