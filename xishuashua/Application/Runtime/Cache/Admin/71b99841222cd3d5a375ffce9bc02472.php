...
<div class="container-fluid">
    ...
    <!--content 1-->
    <div class="row con">
        <a href="dl.html">业主登陆</a>
        <a href="" class="chosed">家装公司登陆</a>
        <div class="col-md-12">
            ...
            <div class="col-md-8">
                <form action="" method="post">
                    <ul class="specialul">
                        <li>
                            <p>公司名称</p>
                            <input type="text" name="realname" placeholder="请填写完整的公司名称"/>
                            <!--输入框内信息判断无误后，使用JS方法显示该图片-->
                            <img src="/h5_2014_xishuashua/xishuashua/Public/admin/images/ok.jpg" alt="ok"/>
                        </li>
                        <li>
                            <p>公司用户名</p>
                            <input type="text" name="name" placeholder="建议使用公司名称的全拼或英文名"/>
                            <!--输入框内信息判断无误后，使用JS方法显示该图片-->
                            <img src="/h5_2014_xishuashua/xishuashua/Public/admin/images/ok.jpg" alt="ok"/>
                        </li>
                        <li class="line"></li>
                        <li>
                            <p>密码</p>
                            <input type="password" name="password" placeholder="不少于六位(字母、数字、下划线)"/>
                            <!--输入框内信息判断无误后，使用JS方法显示该图片-->
                            <img src="/h5_2014_xishuashua/xishuashua/Public/admin/images/ok.jpg" alt="ok"/>
                        </li>
                        <li class="already">
                            <input type="checkbox" name="checkbox" placeholder=""/>我已经阅读并同意<a
                                href="">《xxxxx互联网登陆用户协议》</a>
                        </li>
                        <li>
                            <input type="submit" tabindex="3" value="商家登录" class="btn btn-success"/>
                        </li>
                        <li class="goto">
                            <a href="regist_cp.html">还没账号，赶紧注册&gt;&gt;</a>
                        </li>
                    </ul>
                </form>
            </div>
