           ...
           <table width="100%" border="0" cellspacing="0" cellpadding="0"  class="table  table-striped table-hover ">
            ...
            <?php if(is_array($admin)): $i = 0; $__LIST__ = $admin;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$d): $mod = ($i % 2 );++$i;?><tr>
              ...
              <td><?php echo ($d["email"]); ?></td>
                <td><a href="/h5_2014_xishuashua/h5_2014_xishuashua/xishuashua/index.php/Home/admin/user_update/id/<?php echo ($d["id"]); ?>">修改</a><a href="#"></a> <a
                        href="/h5_2014_xishuashua/h5_2014_xishuashua/xishuashua/index.php/Home/admin/admindelete/id/<?php echo ($d["id"]); ?>">删除</a></td>
