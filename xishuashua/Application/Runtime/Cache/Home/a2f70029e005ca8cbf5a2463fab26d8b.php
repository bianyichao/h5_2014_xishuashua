    	  ...
    	  <div class="table-responsive ">
    	    ...
    	    <div class="list-group ">
    	      <div class="list-group-item">
                ...
                <input type="hidden" name="b_id" value="<?php echo ($a["b_id"]); ?>">
    	          <div class="input-group"> <span class="input-group-addon">昵 称：</span>
                  <input type="text" class="form-control" placeholder="" name="b_ename" value="<?php echo ($a["b_ename"]); ?>">
                </div>
                <div class="input-group"> <span class="input-group-addon">公司名：</span>
                  <input type="text" class="form-control" placeholder="" name="b_name" value="<?php echo ($a["b_name"]); ?>">
                </div>
                <div class="input-group"> <span class="input-group-addon">负责人：</span>
                  <input type="text" class="form-control" placeholder="" name="b_person" value="<?php echo ($a["b_person"]); ?>">
                </div>
                <div class="input-group"> <span class="input-group-addon">地  址：</span>
                  <input type="text" class="form-control" placeholder="" name="b_address" value="<?php echo ($a["b_address"]); ?>">
                </div>
                <div class="input-group"> <span class="input-group-addon">手机号：</span>
                  <input type="text" class="form-control" placeholder="" name="b_tel" value="<?php echo ($a["b_tel"]); ?>">
                </div>
    	          <div class="input-group"> <span class="input-group-addon">邮  箱：</span>
    	            <input type="text" class="form-control" placeholder="86823499@qq.com" name="b_email" value="<?php echo ($a["b_email"]); ?>">
  	            </div>
                <div class="input-group"> <span class="input-group-addon">点赞数：</span>
                  <input type="text" class="form-control" placeholder="" name="b_sum" value="<?php echo ($a["b_sum"]); ?>">
                </div>
                <div class="input-group"> <span class="input-group-addon">信誉度：</span>
                  <input type="text" class="form-control" placeholder="" name="b_credit" value="<?php echo ($a["b_credit"]); ?>">
                </div>
