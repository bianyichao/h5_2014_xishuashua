	...
	<div class="row">
      ...
      <div class="col-md-10 col-md-offset-2 ">
        <ol class="breadcrumb">
          ...
          <li><a href="#">企业账户管理</a></li>
          <li class="active">企业文章管理</li>
        </ol>
        <div class="table-responsive ">
          <h3>企业文章列表 <small>News List</small></h3>
           <table width="100%" border="0" cellspacing="0" cellpadding="0"  class="table  table-striped table-hover ">
            ...
            <?php if(is_array($news)): $i = 0; $__LIST__ = $news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$d): $mod = ($i % 2 );++$i;?><tr>
              ...
              <td><?php echo ($d["bn_id"]); ?></td>
              <td><?php echo ($d["bn_author"]); ?></td>
              <td><?php echo ($d["bn_title"]); ?></td>
              <td><?php echo ($d["bn_inputtime"]); ?></td>
              <td><?php echo ($d["bn_view"]); ?></td>             
              <td><?php echo ($d["bn_content"]); ?></td>
              <td><a href="/h5_2014_xishuashua/xishuashua/index.php/Home/company/newsdelete/bn_id/<?php echo ($d["bn_id"]); ?>">删除</a></td>
