        ...
        <div class="table-responsive ">
          <h3>个人用户管理列表 <small>Personal List</small></h3>
           <table width="100%" border="0" cellspacing="0" cellpadding="0"  class="table  table-striped table-hover ">
            ...
            <?php if(is_array($user)): $i = 0; $__LIST__ = $user;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$d): $mod = ($i % 2 );++$i;?><tr>
              <td><input type="checkbox" name="checkbox" id="checkbox12"></td>
              <td><?php echo ($d["p_id"]); ?></td>
              <td><?php echo ($d["p_name"]); ?></nametd>
              <td><?php echo ($d["p_pwd"]); ?></td>
              <td><?php echo ($d["p_email"]); ?></td>
              <td><?php echo ($d["p_tel"]); ?></td>
                <td><a href="/h5_2014_xishuashua/h5_2014_xishuashua/xishuashua/index.php/Home/personal/user_update/p_id/<?php echo ($d["p_id"]); ?>">修改</a><a href="#"></a> <a href="/h5_2014_xishuashua/h5_2014_xishuashua/xishuashua/index.php/Home/personal/user_delete/p_id/<?php echo ($d["p_id"]); ?>">删除</a></td>
