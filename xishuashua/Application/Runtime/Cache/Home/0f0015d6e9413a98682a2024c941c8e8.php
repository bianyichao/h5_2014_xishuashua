      ...
      <div class=" col-md-2 sidebar">
          ...
          <h3><a href="#"><span class="glyphicon glyphicon-lock"></span>管理员账户管理<span class="glyphicon glyphicon-chevron-down"></span></a></h3>
           <ul>
            ...
            <ul>
              ...
              <li><a href="/h5_2014_xishuashua/xishuashua/index.php/Home/personal/news">个人文章管理</a></li>case
          </ul>
            ...
            <ul>
              ...
              <li><a href="/h5_2014_xishuashua/xishuashua/index.php/Home/company/news">企业文章管理</a></li>
                <li><a href="/h5_2014_xishuashua/xishuashua/index.php/Home/company/casepicture">装修案例管理</a></li>
          </ul>
    	...
    	<div class="col-md-10 col-md-offset-2 ">
    	  <ol class="breadcrumb">
    	    ...
    	    <li class="active">装修案例图片管理</li>
  	    </ol>
    	  <div class="table-responsive ">
    	    <h3>添加图片<small>Company Modify</small></h3>
    	    <div class="list-group ">
    	      <div class="list-group-item">
    	        <form role="form" action="" method="post">
    	          <div class="input-group"> <span class="input-group-addon">装修公司：</span>
                  <select class="form-control" id="select1">       <?php if(is_array($t)): $i = 0; $__LIST__ = $t;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$d): $mod = ($i % 2 );++$i;?><option><?php echo ($d["b_id"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                  </select>

				       </div>
					<div class="input-group"> <span class="input-group-addon">装修的案例ID：</span>
					<select class="form-control" id="select2">
          </select>

					</div>
					  <div class="input-group">
						  <label for="exampleInputFile">添加图片</label><input type="file" id="exampleInputFile" />
					  </div>
...
//     });
  $("#select1").change(function() {
    ...
    var bid = $(this).val();
    //alert(bid);
    $.post("<?php echo U('home/company/se');?>", {id: bid}, function(aa) {
